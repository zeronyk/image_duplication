```usage: main.py [-h] [-l LOG_FILE] [-o OUTPUT_LIST] [-d] [-t] [-ts IMAGEHASH_THRESHOLD] [-rem] [-lvl DIRECTORY_LEVEL] path1 [path1 ...] path2 [path2 ...]
...
optional arguments:
  ...
  -o OUTPUT_LIST, --output-list OUTPUT_LIST
